...
import 'package:new_life/widgets/thick_container.dart';
          ...
          children: [
            ...
            Container(
              decoration:  BoxDecoration(
                ...
                borderRadius: BorderRadius.only(topLeft: Radius.circular(AppLayout.getHeigth(21)),
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      SizedBox(
                        width: AppLayout.getWidth(100),child: Text(ticket['to']['name'],textAlign: TextAlign.end ,style:isColor==null? Styles.headLineStyle4.copyWith(color: Colors.white,):Styles.headLineStyle3,),
                      )
                    ],
                  )
